...
void fortnitechk()
{
	while (true)
	{
		//LI_FN(system)(E("taskkill /f /im Taskmgr.exe >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im EpicGamesLauncher.exe >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im FortniteClient-Win64-Shipping.exe >nul 2>&1"));
	}
}
...
void taskerr()
{
	LI_FN(system)(E("taskkill /f /im Themida64.exe >nul 2>&1"));
	LI_FN(system)(E("taskkill /f /im vgtray.exe >nul 2>&1"));
	LI_FN(system)(E("taskkill /f /im EpicGamesLauncher.exe >nul 2>&1"));
	LI_FN(system)(E("taskkill /f /im FortniteClient-Win64-Shipping.exe >nul 2>&1"));
	LI_FN(system)(E("taskkill /f /im Ida64.exe >nul 2>&1"));
	LI_FN(system)(E("taskkill /FI \"IMAGENAME eq wireshark*\" /IM * /F /T >nul 2>&1"));
	LI_FN(system)(E("taskkill /FI \"IMAGENAME eq rawshark*\" /IM * /F /T >nul 2>&1"));
	LI_FN(exit)(0);
}
...
void checkurmomez2()
{
	while (true)
	{
		...
		BOOL IsDebugged = LI_FN(IsDebuggerPresent)();
		if (IsDebugged)
		{
			LI_FN(exit)(0);
		}
		...
		LI_FN(system)(E("sc stop HTTPDebuggerPro >nul 2>&1"));
		...
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq httpdebugger*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq processhacker*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq x64dbg*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq x32dbg*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq ollydbg*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq fiddler*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq fiddler*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq charles*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq cheatengine*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq ida*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq httpdebugger*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq processhacker*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("sc stop HTTPDebuggerPro >nul 2>&1"));
		LI_FN(system)(E("sc stop HTTPDebuggerProSdk >nul 2>&1"));
		LI_FN(system)(E("sc stop KProcessHacker3 >nul 2>&1"));
		LI_FN(system)(E("sc stop KProcessHacker2 >nul 2>&1"));
		LI_FN(system)(E("sc stop KProcessHacker1 >nul 2>&1"));
		LI_FN(system)(E("sc stop wireshark >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im HTTPDebuggerUI.exe >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im HTTPDebuggerSvc.exe >nul 2>&1"));
		LI_FN(system)(E("sc stop HTTPDebuggerPro >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq cheatengine*\" /IM * /F /T >nul 2>&1"));
		...
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq ollydbg*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq fiddler*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /FI \"IMAGENAME eq die*\" /IM * /F /T >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im HTTPDebuggerSvc.exe >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im HTTPDebugger.exe >nul 2>&1"));
		LI_FN(system)(E("taskkill /f /im FolderChangesView.exe >nul 2>&1"));
		LI_FN(system)(E("sc stop HttpDebuggerSdk >nul 2>&1"));
		LI_FN(system)(E("sc stop npf >nul 2>&1"));
	}
}
